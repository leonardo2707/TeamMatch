...
/*    public EditarPessoas(GerenciadorDeJanelas dados) {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Adicionar Pessoas");
...
*/
    ...
    /*public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditarPessoas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EditarPessoas().setVisible(true);
            }
        });
    }
